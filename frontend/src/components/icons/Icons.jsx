...
export function MandalaMotifIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <rect x="10.5" y="10.5" width="3" height="3" rx="0.5" transform="rotate(45 12 12)" fill="currentColor" fillOpacity="0.25" />
      <circle cx="12" cy="12" r="0.8" fill="currentColor" />
      
      {/* 4 Cardinal pointed petals */}
      <path d="M12 3.5 C10.8 6.5 10.8 8.5 12 10.5 C13.2 8.5 13.2 6.5 12 3.5 Z" />
      <path d="M12 20.5 C10.8 17.5 10.8 15.5 12 13.5 C13.2 15.5 13.2 17.5 12 20.5 Z" />
      <path d="M3.5 12 C6.5 10.8 8.5 10.8 10.5 12 C8.5 13.2 6.5 13.2 3.5 12 Z" />
      <path d="M20.5 12 C17.5 10.8 15.5 10.8 13.5 12 C15.5 13.2 17.5 13.2 20.5 12 Z" />

      {/* 4 Diagonal ornate loops / lobes */}
      <path d="M7 7 C7 5.2 8.8 5.2 9.8 6.2 C10.8 7.2 9.8 9.5 8 9.5 C6.2 9.5 5.2 8.8 7 7 Z" />
      <path d="M17 7 C17 5.2 15.2 5.2 14.2 6.2 C13.2 7.2 14.2 9.5 16 9.5 C17.8 9.5 18.8 8.8 17 7 Z" />
      <path d="M7 17 C7 18.8 8.8 18.8 9.8 17.8 C10.8 16.8 9.8 14.5 8 14.5 C6.2 14.5 5.2 15.2 7 17 Z" />
      <path d="M17 17 C17 18.8 15.2 18.8 14.2 17.8 C13.2 16.8 14.2 14.5 16 14.5 C17.8 14.5 18.8 15.2 17 17 Z" />

      {/* Outer subtle accent dots */}
      <circle cx="12" cy="1.8" r="0.6" fill="currentColor" />
      <circle cx="12" cy="22.2" r="0.6" fill="currentColor" />
      <circle cx="1.8" cy="12" r="0.6" fill="currentColor" />
